...
const Appointments = () => {
    ...
    const handleUpdateAppointment = (id, e) => {
        ...
        axios.post(`http://localhost:5000/appointments/update/${id}`, selectedAppointment)
            .then(() => {
                setAppointments(appointments.map(appointment => (appointment._id === id ? selectedAppointment : appointment)));
        ...
        <div className='container'>
            ...
            <div className='form-container'>
                ...
                <form className='appointment-form' onSubmit={isEditMode ? (e) => handleUpdateAppointment(selectedAppointment._id, e) : handleAddAppointment}>
                    ...
                    <input type='text' value={isEditMode ? selectedAppointment.doctorName : newAppointment.doctorName}
                    ...
                    <label>Date:</label>
                    <input type='date' value={isEditMode ? selectedAppointment.date : newAppointment.date}
                    ...
                    <button type='submit' className='btn-primary'>{isEditMode ? 'Update Appointment' : 'Add Appointment'}</button>
                </form>
            </div>
